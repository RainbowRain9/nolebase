...
![](https://i-blog.csdnimg.cn/direct/bf97d49148f0454da4077bba54fe5b2a.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/816f950cf6334113b28f478779485224.png#pic_center)
...
1.  **打开软件源配置文件**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/173413a1053c4175bcbb225fe3a6f71b.png#pic_center)
...
2.  **替换默认源**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/88da0ab1bc7c49768a70c707f09fb625.png#pic_center)
    ...
    **清华源配置**后的界面如下所示：
    ...
    ![](https://i-blog.csdnimg.cn/direct/510fd63378714a5495033c8975cb1b24.png#pic_center)
...
4.  **更新软件包列表**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/1e19b7c52a104da0b33e3e852b9fc378.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/3514f01f929d45d399e02d2abbec9264.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/0c86b44b372e4466b6252d94d4fe9bd5.png#pic_center)
...
1.  打开 “软件和更新” 应用。在 Ubuntu 的启动栏中找到这个应用，图标如下：
    ...
    ![](https://i-blog.csdnimg.cn/direct/56cf22a57d974b999ae5cd33c917b0af.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/ac7fadf96cc54b2a922c807eac3f76ab.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/a346cf03739746f4a16ee497b0bbd985.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/15a64dd190e3467b806681603e556f77.png#pic_center)  
我这里选择 12.2 的版本，**你注意看好自己的版本**。如下图所示：

![](https://i-blog.csdnimg.cn/direct/852d9c8a3fa44e2f97e36802183743ed.png#pic_center)

这里按照操作系统的版本选择如下：

![](https://i-blog.csdnimg.cn/direct/1c06487806db421693c3fcd8c5e9e713.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/8595007508c641ea9eef26eef5cf738f.png#pic_center)
...
1.  下载 CUDA 配置文件：
    ...
    ![](https://i-blog.csdnimg.cn/direct/c75ef5907071442f8cd6214257cd6141.png#pic_center)
...
2.  移动配置文件到指定目录：
    ...
    ![](https://i-blog.csdnimg.cn/direct/179143a6adbc473e93ae688df05414a2.png#pic_center)
...
3.  下载 CUDA 安装包：
    ...
    ![](https://i-blog.csdnimg.cn/direct/bf68c1ce7db64460b9e88998ab1e27bd.png#pic_center)
...
4.  安装下载的 CUDA 包：
    ...
    ![](https://i-blog.csdnimg.cn/direct/a4f83301badb4365b6c5ca8b3e5c402a.png#pic_center)
...
5.  复制 GPG 密钥到系统的受信任密钥列表中：
    ...
    ![](https://i-blog.csdnimg.cn/direct/1a5d5ec25b384553b32662ec7d1fee28.png#pic_center)
...
6.  更新软件包列表并安装 CUDA：
    ...
    ![](https://i-blog.csdnimg.cn/direct/a11d09693a6e4dd6990a0216cbc079bd.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/3a56f5b05c7244c7b1c1b7ec9dbd22b3.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/62b35a10d7ef479aba7c9e71d9268d7d.png#pic_center)
...
1.  **访问 cuDNN 下载页面**：进入 cuDNN 下载页面，点击 “Download cuDNN”，如下图所示：
    ...
    ![](https://i-blog.csdnimg.cn/direct/e2872f0d974a43a98c7118f0fc29a8e2.png#pic_center)
...
2.  **选择合适的 cuDNN 版本**：进入下载页面后，你通常会看到当前最新版本的 cuDNN。为了保证与深度学习框架的兼容性，建议选择与已安装的 CUDA 版本相匹配的 cuDNN 版本。点击页面右下角的 “[Archived cuDNN Releases](https://developer.nvidia.com/rdp/cudnn-archive)”，以选择一个稍早版本的 cuDNN。
    ...
    ![](https://i-blog.csdnimg.cn/direct/e9316fb5d20b496b8431dc84bcd87552.png#pic_center)
    
3.  **选择具体的 cuDNN 版本**：在存档版本页面中，选择适合你 CUDA 版本的 cuDNN 版本。在本例中，我们选择的是与 CUDA 12.2 兼容的 cuDNN 8.8.1 版本。
    
    ![](https://i-blog.csdnimg.cn/direct/c746dcea21a14cc5a57374adb957580f.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/efd81fc1d39047b7aa0dd66c309c9ac6.png#pic_center)

在这个页面，点击 “Download cuDNN” 按钮开始下载。需要登录你的 NVIDIA 账户，如果还没有账户，可以点击注册。

![](https://i-blog.csdnimg.cn/direct/947c352fbfc04372b088d619bdd4c54c.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/0203f3f890d5451ea66c49dc3c87e68c.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/166358495f7548e1ab79c87b7435954d.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/c57639107b024d3495c3f35813f28085.png#pic_center)
...
3.  **更新并安装 cuDNN 包**：更新你的包列表并安装 cuDNN 包：
    ...
    首先输入第一条的更新，如下：  
    ![](https://i-blog.csdnimg.cn/direct/dc2c96b1253143149ccaf2485b29e32d.png#pic_center)
    
    然后输入第二条，系统会下载并安装必要的 cuDNN 包，输出类似以下内容：
    

![](https://i-blog.csdnimg.cn/direct/018eebe0965748af9f0993acc39877cf.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/63884729f1e641748bf407e69591b6f6.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/db743bfe765d49c7b956036281d1b6b4.png#pic_center)
...
1.  **下载 Miniconda 安装脚本**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/f40962f337ba4f28bac49e7809ba355b.png#pic_center)
...
2.  **验证安装脚本（可选）**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/b51c725e6ccc4079a210da10e97d2576.png#pic_center)
...
3.  **运行安装脚本**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/0baca932f28b404abac2960d40fc34d9.png#pic_center)
    
4.  **通过安装过程**：
    
    执行安装脚本后，会提示你阅读许可协议。按 `Enter` 键滚动到协议末尾，然后输入 `yes` 同意许可协议。
    
    ![](https://i-blog.csdnimg.cn/direct/b2a625b0409c4bf3a2375826dfd06792.png#pic_center)
    
    接着，它会询问你安装的位置。默认安装路径是你的主目录下的 `~/miniconda3`。你可以直接按 `Enter` 接受默认路径，或者输入自定义路径。
    
    ![](https://i-blog.csdnimg.cn/direct/0650e4ce883448daba4a6a8cebef3684.png#pic_center)
...
5.  **初始化 Miniconda**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/56a24a0990d64bebbe110a9976423fb6.png#pic_center)
...
6.  **激活 Miniconda**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/2a4c0d8614da41a8a6bb103c1ee5d8c1.png#pic_center)
...
7.  **测试安装**：
    ...
    ![](https://i-blog.csdnimg.cn/direct/4687a28bb2604cbfa3d18aa086345b9c.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/b9a620c7954c4f7e82c6b2f937e249d7.png#pic_center)

![](https://i-blog.csdnimg.cn/direct/1fc6d1076aea43c092467bee30af3769.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/f2d9eff55bd74227a0bc00fec9381ac3.png#pic_center)

访问 [PyTorch 官网](https://pytorch.org/) 获取安装命令，为了兼容性避免出错，可以进到[早前版本](https://pytorch.org/get-started/previous-versions/)，通常如下：

![](https://i-blog.csdnimg.cn/direct/68db40b644ba46b8a8365c777dcd60e7.png#pic_center)  
使用 pip 安装的命令如下：
...
![](https://i-blog.csdnimg.cn/direct/b249f17a594b44b1bba95d736af8e3cd.png#pic_center)
...
![](https://i-blog.csdnimg.cn/direct/2614c85bab09432d8c3585509547a121.png#pic_center)