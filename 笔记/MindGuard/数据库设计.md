...
| 情绪与记录 | `checkins`、`journals`、`daily_reports`、`weekly_summaries` | 情绪打卡与心情随笔沉淀原始数据，按日/周汇总支撑趋势分析、周报与建议生成。|
...
| `highlight_journal_ids` | Array&lt;UUID&gt; | 代表性心情随笔引用。|
