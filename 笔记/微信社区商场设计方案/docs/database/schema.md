...
> **⚠️ 重要说明**: 本文档为传统数据库设计方案，仅供参考。项目实际采用微信小程序云开发的 MongoDB 数据库。如需了解实际使用的数据库设计，请参考 [云数据库结构设计](./cloud-schema.md)。

## 概述

本文档详细描述了微信社区商场小程序的传统数据库结构设计，包括所有表结构、字段说明、索引设计、约束关系等。数据库采用MySQL 8.0，支持高并发访问和数据一致性。

**技术架构对比**:
- **传统方案**: MySQL + Node.js/Express (本文档)
- **实际采用**: MongoDB 云数据库 + 云函数
